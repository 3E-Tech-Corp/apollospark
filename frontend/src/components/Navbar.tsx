      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-2">
            <img src="/images/logo.jpg" alt="ApolloSpark" className="w-[100px] h-[100px] rounded-full object-cover ring-2 ring-amber-500/30 -my-5 relative z-[60] drop-shadow-lg" />
